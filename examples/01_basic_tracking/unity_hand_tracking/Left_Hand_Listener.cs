...
public class Left_Hand_Listener : MonoBehaviour
{
    [Header("Network Settings")]
    public int port = 5015;  // Changed to 5015
    ...
    void Start()
    {
        ...
        Debug.Log($"Left Hand Listener started on port {port}");
    }
        ...
        lock (dataLock)
        {
            ...
            for (int i = 0; i < boneHierarchy.Length; i++)
            {
                ...
                if (startIndex + 2 < latestData.Length)
                {
                    ...
                    if (showDebugInfo && i == debugJointIndex && frameCount % 30 == 0) // Every 30 frames
                    {
    ...
    void OnApplicationQuit()
    {
        ...
        Debug.Log("Left Hand Listener stopped");
    }
