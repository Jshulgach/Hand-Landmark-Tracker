# OptiTrack Test Sender and Receiver Scripts

These scripts allow you to test hand tracking data broadcasting without needing cameras.

`test_sender.py` remains in the packaged OptiTrack module and is exposed as:
...
```bash
cd examples/01_basic_tracking/unity_hand_tracking/optitrack_tools
