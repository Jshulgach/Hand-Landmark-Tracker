...
EMG_DATA_FILE = 'data/hand_dynamic_joint_angles_dataset.npz'
MODEL_PATH = '../../data/joint_angle_emg_regressor.pth'
SCALER_MEAN_PATH = '../../data/joint_angle_feature_scaler.npy'
SCALER_STD_PATH = '../../data/joint_angle_feature_scaler_std.npy'
