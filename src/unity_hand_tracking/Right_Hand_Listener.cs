...
public class Right_Hand_Listener : MonoBehaviour
{
    [Header("Network Settings")]
    public int port = 5017;
    ...
    void Start()
    {
        ...
        Debug.Log($"Right Hand Listener started on port {port}");
    }
    ...
    void OnApplicationQuit()
    {
        ...
        Debug.Log("Right Hand Listener stopped");
    }
