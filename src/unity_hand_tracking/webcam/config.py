...
# Keep None to avoid forcing manual exposure on webcams that use different scales.
CAMERA_EXPOSURE = None
MJPEG_MODE = 0  # Kept for compatibility with shared call signatures
DISPLAY_SCALE = 1.0  # Global scaling for UI
GRID_COLS = 3  # Grid layout for visualization
WEBCAM_INDICES = [0, 1, 2, 3]  # Probed in order; unavailable indices are skipped
# Keep webcam capture properties at driver defaults in multi_webcam.py.
