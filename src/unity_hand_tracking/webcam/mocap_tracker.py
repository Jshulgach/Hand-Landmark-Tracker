...
Uses CameraManager (multi_webcam.py) for webcam capture.
...
class MultiCameraTracker:
    """Tracks hands across multiple calibrated webcams."""
    ...
    def initialize_cameras(
        ...
        """
        # Load MediaPipe before webcam initialization.
        # Rationale: in some Windows shell/runtime combinations, loading the
        # native camera stack first can cause MediaPipe's _framework_bindings
